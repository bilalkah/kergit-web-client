...
export type VideoQualityPreset = '720p60' | '1080p30'
...
// Old/invalid stored values (e.g. 720p30, 1080p60, 1440p30) normalize to 720p60.
export const DEFAULT_CAMERA_QUALITY: VideoQualityPreset = '720p60'
