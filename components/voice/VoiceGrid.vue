  ...
  <div ref="gridRoot" class="voice-grid-root" @mousemove="onMouseMove">
      ...
      <div v-if="isSpotlight && focusedEntry" class="voice-spotlight">
        <div class="spotlight-main">
          <VoiceGridTile
            ...
            :is-local="focusedEntry.isLocal"
            :mode="focusedEntry.type"
            :track-revision="trackRevision"
        ...
        <div v-if="stripEntries.length > 0 && !stripHidden" class="spotlight-strip">
          <VoiceGridTile
            v-for="entry in stripEntries"
            :key="entry.key"
            :participant="entry.participant"
            :is-local="entry.isLocal"
            :mode="entry.type"
            :track-revision="trackRevision"
            :screen-subscribed="isScreenSubscribed(entry.participant.identity)"
            @click="onStripTileClick(entry)"
    ...
    <div class="voice-toolbar" :class="{ 'controls-hidden': controlsHidden }">
      <Tooltip v-if="app.voiceNeedsAudioUnlock" content="Sesi etkinleştir">
        <button
          class="toolbar-btn toolbar-btn-unlock"
          @click="unlockAudioPlayback"
        >
          Enable Audio
        </button>
      </Tooltip>
      ...
      <Tooltip content="Mikrofon">
        <button
          class="toolbar-btn"
          :class="{ 'toolbar-btn-danger': app.voiceMuted }"
          @click="toggleMute"
        >
      ...
      <Tooltip content="Kamera">
        <button
          class="toolbar-btn"
          :class="{ 'toolbar-btn-active': app.localCameraEnabled }"
      ...
      <Tooltip content="Ekran Paylaş">
        <button
          class="toolbar-btn"
          :class="{ 'toolbar-btn-active': app.localScreenShareEnabled }"
      ...
      <Tooltip content="Bağlantıyı Kes">
        <button
          class="toolbar-btn toolbar-btn-disconnect"
          @click="onDisconnect"
        >
          <IconPhoneOff />
        </button>
