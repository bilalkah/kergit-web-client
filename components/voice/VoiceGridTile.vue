...
import { allowScreenShareAudio, disallowScreenShareAudio } from '@/src/services/webrtc/livekit'
...
const displayName = computed(() => {
  if (props.isLocal) return app.username ?? 'Sen'
...
watch(publication, (pub) => {
  if (!pub && isScreenShareMode.value) {
